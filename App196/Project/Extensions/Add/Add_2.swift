    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "kusokIsApp": myData.isVpn,
                "mirroredAppNow": myData.uniqueNumber,
                "isNowLater": myData.wifiAddress,
                "laterIsNow": myData.isCharging,
            ]
